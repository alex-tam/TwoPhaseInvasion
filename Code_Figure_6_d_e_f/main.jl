...
@with_kw struct Params
    ...
    κu::Float64 = -0.05 # [-] Inverse Stefan number (u)
    ...
    β::Float64 = 10.0 # [-] Initial interface position
...
function fisher_stefan_2d()
    ...
    par = Params(q = 2*π/5, Nt = 3001, T = 30.0) # Initialise data structure of model parameters
